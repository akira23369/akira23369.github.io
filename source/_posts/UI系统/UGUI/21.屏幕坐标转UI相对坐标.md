...
public class ScreenPointToLocalPointInRectangleTest : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
{
    ...
    public void OnBeginDrag(PointerEventData eventData)
    {
        ...
        RectTransformUtility.ScreenPointToLocalPointInRectangle(
            ...
            canvas.worldCamera,
            out Vector2 localPoint    // 这里可以直接定义
        );
...
对于 UI 元素的拖拽，必须使用 rectTransform.anchoredPosition，因为它遵循 UI 布局系统的锚点和像素单位，能保证位置正确；而 transform.localPosition 适用于 3D 物体，用于 UI 元素可能导致位置错乱（尤其当父对象有缩放或锚点变化时）。
...
public class GamePanel : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        entry.callback.AddListener((data) =>
        {
            ...
            imgJoystick.anchoredPosition = localPoint; // 更新摇杆位置
